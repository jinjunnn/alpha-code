export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Alpha",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Alpha er lastet ned. Vil du installere den og starte på nytt?",
