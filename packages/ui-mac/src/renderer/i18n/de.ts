export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Alpha",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Alpha wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
