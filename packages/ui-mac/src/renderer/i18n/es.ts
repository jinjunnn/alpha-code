export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Alpha",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Alpha. ¿Quieres instalarla y reiniciar?",
