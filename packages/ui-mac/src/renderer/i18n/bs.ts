export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Alpha-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Alpha-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
