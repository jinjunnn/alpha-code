export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Alpha",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Alpha a été téléchargée. Voulez-vous l'installer et redémarrer ?",
