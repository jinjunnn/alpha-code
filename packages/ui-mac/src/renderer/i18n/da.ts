export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Alpha",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Alpha er blevet downloadet. Vil du installere den og genstarte?",
