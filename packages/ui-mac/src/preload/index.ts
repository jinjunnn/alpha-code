...
const api: ElectronAPI = {
  ...
  ext: {
    ...
    importAgentPreview: (filePath) => ipcRenderer.invoke("ext-import-agent-preview", filePath),
    importAgentConfirm: (composed) => ipcRenderer.invoke("ext-import-agent-confirm", composed),
