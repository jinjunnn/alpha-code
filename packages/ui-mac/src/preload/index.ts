...
const api: ElectronAPI = {
  ...
  workspaceWriteProbe: (directory) => ipcRenderer.invoke("workspace-write-probe", directory),
  ...
  ext: {
    ...
    uninstallPackage: (packageId) => ipcRenderer.invoke("ext-uninstall-package", packageId),
    packageInstalled: (catalogId) => ipcRenderer.invoke("ext-package-installed", catalogId),
