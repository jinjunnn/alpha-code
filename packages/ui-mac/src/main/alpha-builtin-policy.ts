...
/** alpha 注入 agent(S18 X2):disable/hide 都拒绝 —— 治理它们 = 自动化/只读/请求审批档静默失效。 */
export const ALPHA_INJECTED_AGENTS = ["alpha-automation", "alpha-automation-standard", "alpha-readonly", "alpha-ask"] as const
