...
| [ADR-014](adrs/ADR-014-extension-hub.md) | 定制中心:Skills/MCP/Plugins 市场 + alpha 自建套件 + 零-fork 安装(2026-07-04 v3 修订:全类型通用化 —— 账本/`.alpha`桥/免重启 dispose/密钥 file 化;O1-O4 拍板) | trial(v3 转 accepted 待桌面真机批) | 2026-06-22 |
...
| [ADR-022](adrs/ADR-022-automations.md) | 自动化定时任务:本地调度器 + 只读 agent 静态权限档 + `.alpha` 落盘(REQ-021 A1;A2/A3 分期) | trial(转 accepted 待真机批) | 2026-07-04 |
