...
| REQ-079 精选清单残点:撤原生平铺方向已拍板(2026-07-09);新增精选 = REQ-080 三连+office-docs、REQ-082 cloud-dispatch;残余 = 现有 catalog 条目(code-reviewer/bug-triage)是否删减/是否再补充 —— 开工时提案 | REQ-079 | 不阻塞开工 |
