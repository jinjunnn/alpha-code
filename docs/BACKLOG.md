...
| REQ-021 | 自动化(定时任务)完整需求:A1 本地只读 MVP → A2 增强 → A3 云档位 | feature | A | in-sprint | **S15 抽取(2026-07-04,仅 A1;A2/A3 留册)**,契约 [sprints/2026-07-04-s15-automations-a1](sprints/2026-07-04-s15-automations-a1/sprint.md);ADR-022 随 PR 立;详见 [requirements/REQ-021](requirements/REQ-021-automations.md) |
