...
> 下一个新需求编号:**REQ-049**(新需求一律 REQ-NNN;A/B/C/D/E 为历史审计系列保留原号,用户 2026-07-03 确认)。
...
| ID | 标题 | 类 | 仓 | 状态 | 备注 |
|---|---|---|---|---|---|
| REQ-048 | catalog 存量条目缺 per-entry version:每次发版全量误亮「可更新」角标(placebo 更新提示) | debt | C | registered | **S27 真机批发现(2026-07-06)**:已安装角标随 catalog 2026-07-06.2→.3 从 1 涨 4(存量 receipts 版本 < 顶层默认版本,内容实未变);build-catalog.mjs 已 warn 23 条缺显式 version;修=C 侧 catalog-src 逐条补 version(内容真变才 bump),A 零动作;证据 [audits/vnext3](audits/2026-07-06-realmachine-vnext3/verify.md) |
...
## 当前 sprint → **S27 真机批 vNext-3(2026-07-06 开批,场次一已跑)**
