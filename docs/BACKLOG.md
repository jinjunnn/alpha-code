...
| REQ-076 Windows 三决策:① Authenticode 证书形态(个人 vs OV/EV,SmartScreen 信誉周期)② 密钥文件 Windows 保护(icacls ACL vs 明示降级,T3 前置)③ Windows on ARM 是否随首发 | REQ-076 / ADR-026 | 影响 T3 发布链与安全基线;T1/T2 不受阻 |
