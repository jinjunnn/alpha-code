...
| --- | --- | --- |
| Extension Hub / 定制中心 | `extension-hub.md` → `2026-06-22-arch-extension-hub.md` → `2026-07-04-extension-hub-v3-universal.md` → `2026-07-13-req103-hub-governance/` (治理三归位 v3) → `2026-07-15-capability-authorize-dialog/` (authorize 确认框增量) → `2026-07-17-req103-remaining/` (scope 分组做实 + 已授权能力段 v4) → `2026-07-17-req104-pack-facts/` (Pack 整包事实 + 第三方默认关 v5) → `2026-07-18-req104-four-shelf/` (四级货架 v6) → `2026-07-30-req128-extension-package-baseline.md` (标准 package、外部 Plugin 适配与兼容宿主安装) | current extension code/tests and ADR-014/ADR-028/ADR-030 |
...
| Tool identity and inventory | [`2026-07-31-tool-identity-baseline.md`](2026-07-31-tool-identity-baseline.md) (draft — 全来源工具 inventory / 稳定 identity;REQ-125 展示与 REQ-131 策略共同消费) | current engine registry/MCP/permission code; supersedes nothing |
