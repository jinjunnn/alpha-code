...
| Alpha Office connectors | [`req-133-office-four-format-hub.md`](req-133-office-four-format-hub.md) (accepted — four Alpha-authored local stdio wrappers, workspace sandbox, exact Hub commands) → [`req-135-retire-community-excel.md`](req-135-retire-community-excel.md) (accepted — Hub Excel is Alpha-only; the community connector is retired) | current `packages/ui-mac/resources/office-mcp`, boot retirement, main MCP policy, and office advisories/tests |
