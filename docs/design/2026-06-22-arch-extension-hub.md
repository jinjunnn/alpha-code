...
(详见 docs/architecture/diagrams/03-flow-install-mcp.svg)
...
(详见 docs/architecture/diagrams/03-flow-install-mcp-rollback.svg)
...
(详见 docs/architecture/diagrams/03-flow-bundle.svg)
...
(详见 docs/architecture/diagrams/03-flow-plugin.svg)
...
- docs/architecture/diagrams/{01,03*,05}-*.{d2,svg}
