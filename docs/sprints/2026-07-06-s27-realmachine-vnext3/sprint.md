...
| T4 | M2 数据/凭证:C16 两级清除 · B14/C17 对话框演练 · B2 短TTL · B21 改键 | 同上 | ◐(场次二:B14 verified · C16 凭证级+全部级安全带 verified〔全部级误执行=事故 REQ-050〕· C17/B2/B21 → 后续批)|
| T5 | M3 云线:B16 同意门 · B3 dispatch 冒烟+回流 · REQ-024/025 e2e | 同上 | ◐(场次二:B16/B3/REQ-020/REQ-024 verified · REQ-025/E2 → 后续批)|
| T6 | M4 稳定性顺带:B22 复现 · B11 实拍 · B20 弱网 · B4 冷启动 · C3 轮转 · B7 release-time 三项 | 同上 | ⬜(全部 → 后续批;E6 readonly verified 顺带)|
...
## 场次二结果(2026-07-06 晚,用户在场)

- **批前置**:catalog 快照刷新至 `.4`(PR #129,守卫 7/7 绿)+ 重 ship 签名+公证包(含 PR #127/#129)+ install-local。
- **翻 verified(8 项)**:REQ-047 · REQ-048 · B16 · B3 · REQ-020 · B14 · E6 · REQ-024 · C16(凭证级+全部级安全带)。证据 [audits/vnext3 场次二](../../audits/2026-07-06-realmachine-vnext3/verify.md)。
- **新登记**:REQ-050(C16 安全硬化,事故触发)· REQ-051(REQ-047 留痕 P3)。
- **⚠️ 事故**:C16 全部级经 AppleScript 自动驱动被误执行(用户原意只验安全带),抹本机登录/扩展/引擎会话库+B14 备份(不可恢复);删除边界守住(项目/配置/仓库未触)。→ REQ-050。
- **未覆盖(后续批)**:C17/B2/B21/REQ-025/E2/B22/B11/B20/B4/C3/B7/REQ-041 switch/REQ-043 switch/REQ-039 cn 真实租户。
- **下一步**:环境重建(用户机器)→ 待 S29 v0.1.1 真实发版(收 B9/B7)。
