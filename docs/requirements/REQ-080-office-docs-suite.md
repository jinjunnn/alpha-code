...
后续生态复核发现：Office Word/PPT 两上游仓已于 2026-03-03 归档；Excel MCP 曾有路径遍历/未认证远程读写 advisory，0.1.8 修复。该事实不改写本项 shipped 历史，但在独立纠偏 [[REQ-105]] 完成前，本项不得翻 verified；stable 推荐、bundle 与离线快照的处置以 REQ-105 为准。Office 应用内预览与视觉正确性另见 [[REQ-097]]。
