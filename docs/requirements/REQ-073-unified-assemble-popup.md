...
created: 2026-07-09
status: registered
source: 用户直提(2026-07-09,5 截图:Codex 统一菜单/计划模式 chip 参照 + alpha 现状 @/+/build 三处)
---
...
## 待拍板(6 点,拍板后翻 ready → 出设计稿)

| # | 决策点 | 建议 |
|---|---|---|
| 1 | **GLOSSARY 语法分工 v2 口径**(2026-07-09 上午刚固化 v1「@ = 引用」,本需求把附加/模式也收进 @/+,需显式修订而非静默漂移) | 「`/` = 执行;`@`/`+` = **装配本条消息**(引用 · 附加 · 模式)」 |
