// #583/#584/#586 deterministic capture driver — installed Chrome in true headless mode;
// never starts Electron or the Alpha Code application. Same pattern as the accepted
// 2026-08-12-587-tool-card-provenance driver.
...
const baseURL = process.env.HARNESS_583_URL ?? "http://127.0.0.1:4189/"
const chrome = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"

const states = ["list", "grep", "grep-hidden", "websearch", "all"]
...
const metadata = {
  ...
  harnessSha256: createHash("sha256")
    .update(await readFile(`${here}/tool-cards-harness.tsx`))
    .digest("hex"),
